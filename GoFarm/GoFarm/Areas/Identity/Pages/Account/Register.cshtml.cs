        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //if value is admin, we are asigning admin role to user
                    if (role == SD.Admin)
                    {
                        await _userManager.AddToRoleAsync(user, SD.Admin);
                    }
                    //if not, then we are asigning manager role.
                    else
                    {
                        if (role == SD.Manager) {
                    ...
                    /* Email confirmation, not needed in this case
                     * 
                    ...
                    {
                        //because admin is creating new users, we dont want to automatically sign them in
